...
\twocolumn[
    ...
    \\~\\ % parskip doesn't function in here, apparently
...
\begin{figure*}[h]
    ...
    \fi
    \caption{Illustration of the estimation of chromaticity from a spectrum.  The three left panels show the products of the three color matching functions with the $D65$ spectrum.  The area shaded under each resulting curve is annotated within each panel by applying equation \ref{eq:tristimulus_from_spectrum}.  The right panel shows the resulting chromaticity coordinate $(x,y)$.  IMAGE LINK, CODE LINK}\label{fig:estimating_d65_chromaticity}
\end{figure*}
