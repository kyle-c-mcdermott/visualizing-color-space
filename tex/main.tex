...
\begin{figure} % Figure 1
    \ifinvert
        \includesvg{../images/figure_01_color_matching_experiment_data_inverted.svg}
    \else
        \includesvg{../images/figure_01_color_matching_experiment_data.svg}
    \fi
...
\begin{figure} % Figure 2
    \ifinvert
        \includesvg{../images/figure_02_color_matching_experiment_chromaticity_inverted.svg}
    \else
        \includesvg{../images/figure_02_color_matching_experiment_chromaticity.svg}
    \fi
...
\begin{figure} % Figure 3
    \ifinvert
        \includesvg{../images/figure_03_unnormalized_cone_fundamentals_inverted.svg}
    \else
        \includesvg{../images/figure_03_unnormalized_cone_fundamentals.svg}
    \fi
...
\begin{figure} % Figure 4
    \ifinvert
        \includesvg{../images/figure_04_cone_fundamentals_inverted.svg}
    \else
        \includesvg{../images/figure_04_cone_fundamentals.svg}
    \fi
...
\begin{figure} % Figure 5
    \ifinvert
        \includesvg{../images/figure_05_color_matching_functions_inverted.svg}
    \else
        \includesvg{../images/figure_05_color_matching_functions.svg}
    \fi
...
\begin{figure} % Figure 6
    \ifinvert
        \includesvg{../images/figure_06_d65_spectrum_inverted.svg}
    \else
        \includesvg{../images/figure_06_d65_spectrum.svg}
    \fi
...
\begin{figure} % Figure 7
    \ifinvert
        \includesvg{../images/figure_07_estimating_d65_chromaticity_inverted.svg}
    \else
        \includesvg{../images/figure_07_estimating_d65_chromaticity.svg}
    \fi
...
\begin{figure} % Figure 8
    \ifinvert
        \includesvg{../images/figure_08_chromaticity_spaces_inverted.svg}
    \else
        \includesvg{../images/figure_08_chromaticity_spaces.svg}
    \fi
...
\begin{figure} % Figure 9
    \ifinvert
        \includesvg{../images/figure_09_color_matching_experiment_tristimulus_inverted.svg}
    \else
        \includesvg{../images/figure_09_color_matching_experiment_tristimulus.svg}
    \fi
...
\begin{figure} % Figure 10
    \ifinvert
        \includesvg{../images/figure_10_color_matching_experiment_mixing_inverted.svg}
    \else
        \includesvg{../images/figure_10_color_matching_experiment_mixing.svg}
    \fi
...
\begin{figure} % Figure 11
    \ifinvert
        \includesvg{../images/figure_11_crt_monitor_inverted.svg}
    \else
        \includesvg{../images/figure_11_crt_monitor.svg}
    \fi
...
\begin{figure} % Figure 12
    \ifinvert
        \includesvg{../images/figure_12_3d_srgb_inverted.svg}
    \else
        \includesvg{../images/figure_12_3d_srgb.svg}
    \fi
...
\begin{figure} % Figure 13
    \ifinvert
        \includesvg{../images/figure_13_3d_chromoluminance_inverted.svg}
    \else
        \includesvg{../images/figure_13_3d_chromoluminance.svg}
    \fi
...
\begin{figure} % Figure 14
    \ifinvert
        \includesvg{../images/figure_14_chromaticity_inside_gamut_inverted.svg}
    \else
        \includesvg{../images/figure_14_chromaticity_inside_gamut.svg}
    \fi
...
\begin{figure} % Figure 15
    \ifinvert
        \includesvg{../images/figure_15_chromaticity_outside_gamut_inverted.svg}
    \else
        \includesvg{../images/figure_15_chromaticity_outside_gamut.svg}
    \fi
...
\begin{figure} % Figure 16
    \ifinvert
        \includesvg{../images/figure_16_chromaticity_without_gamma_correction_inverted.svg}
    \else
        \includesvg{../images/figure_16_chromaticity_without_gamma_correction.svg}
    \fi
...
\begin{figure} % Figure 17
    \ifinvert
        \includesvg{../images/figure_17_gamma_correction_in_chromoluminance_inverted.svg}
    \else
        \includesvg{../images/figure_17_gamma_correction_in_chromoluminance.svg}
    \fi
...
\begin{figure} % Figure 18
    \ifinvert
        \includesvg{../images/figure_18_visible_spectrum_locus_inverted.svg}
    \else
        \includesvg{../images/figure_18_visible_spectrum_locus.svg}
    \fi
...
\begin{figure} % Figure 19
    \ifinvert
        \includesvg{../images/figure_19_visible_spectrum_functions_inverted.svg}
    \else
        \includesvg{../images/figure_19_visible_spectrum_functions.svg}
    \fi
...
\begin{figure} % Figure 20
    \ifinvert
        \includesvg{../images/figure_20_blackbody_spectra_inverted.svg}
    \else
        \includesvg{../images/figure_20_blackbody_spectra.svg}
    \fi
...
\begin{figure} % Figure 21
    \ifinvert
        \includesvg{../images/figure_21_two_chromaticity_spaces_inverted.svg}
    \else
        \includesvg{../images/figure_21_two_chromaticity_spaces.svg}
    \fi
...
\begin{figure} % Figure 22
    \ifinvert
        \includesvg{../images/figure_22_isotherm_lines_zoom_inverted.svg}
    \else
        \includesvg{../images/figure_22_isotherm_lines_zoom.svg}
    \fi
...
\begin{figure} % Figure 23
    \ifinvert
        \includesvg{../images/figure_23_cie_1931_isotherm_inverted.svg}
    \else
        \includesvg{../images/figure_23_cie_1931_isotherm.svg}
    \fi
...
\begin{figure} % Figure 24
    \ifinvert
        \includesvg{../images/figure_24_single_protan_inverted.svg}
    \else
        \includesvg{../images/figure_24_single_protan.svg}
    \fi
...
\begin{figure} % Figure 25
    \ifinvert
        \includesvg{../images/figure_25_multiple_protan_inverted.svg}
    \else
        \includesvg{../images/figure_25_multiple_protan.svg}
    \fi
...
\begin{figure} % Figure 26
    \ifinvert
        \includesvg{../images/figure_26_copunctal_points_inverted.svg}
    \else
        \includesvg{../images/figure_26_copunctal_points.svg}
    \fi
...
\begin{figure} % Figure 27
    \ifinvert
        \includesvg{../images/figure_27_color_blind_stimuli_inverted.svg}
    \else
        \includesvg{../images/figure_27_color_blind_stimuli.svg}
    \fi
...
\begin{figure} % Figure 28
    \ifinvert
        \includesvg{../images/figure_28_color_blind_stimuli_contrast_inverted.svg}
    \else
        \includesvg{../images/figure_28_color_blind_stimuli_contrast.svg}
    \fi
...
\begin{figure} % Figure 29
    \ifinvert
        \includesvg{../images/figure_29_color_blind_filter_photograph_inverted.svg}
    \else
        \includesvg{../images/figure_29_color_blind_filter_photograph.svg}
    \fi
...
\begin{figure} % Figure 30
    \ifinvert
        \includesvg{../images/figure_30_color_blind_filter_stimulus_inverted.svg}
    \else
        \includesvg{../images/figure_30_color_blind_filter_stimulus.svg}
    \fi
