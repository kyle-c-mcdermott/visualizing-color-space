...
\begin{figure*}[h]
    \ifinvert
        \includesvg[width=\textwidth]{../images/figure_26_copunctal_points_inverted.svg}
    \else
        \includesvg[width=\textwidth]{../images/figure_26_copunctal_points.svg}
    \fi
...
\begin{figure*}[h]
    \ifinvert
        \includesvg[width=\textwidth]{../images/figure_27_color_blind_stimuli_inverted.svg}
    \else
        \includesvg[width=\textwidth]{../images/figure_27_color_blind_stimuli.svg}
    \fi
...
\begin{figure*}[h]
    \ifinvert
        \includesvg[width=\textwidth]{../images/figure_28_color_blind_stimuli_contrast_inverted.svg}
    \else
        \includesvg[width=\textwidth]{../images/figure_28_color_blind_stimuli_contrast.svg}
    \fi
...
\begin{figure*}[h]
    \ifinvert
        \includesvg[width=\textwidth]{../images/figure_29_color_blind_filter_photograph_inverted.svg}
    \else
        \includesvg[width=\textwidth]{../images/figure_29_color_blind_filter_photograph.svg}
    \fi
...
\begin{figure*}[h]
    \ifinvert
        \includesvg[width=\textwidth]{../images/figure_30_color_blind_filter_stimulus_inverted.svg}
    \else
        \includesvg[width=\textwidth]{../images/figure_30_color_blind_filter_stimulus.svg}
    \fi
